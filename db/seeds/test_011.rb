...
Division.create(division_id: 1,text: '観察',standard: 24,problem_id: problem.id)
Division.create(division_id: 2,text: '説明',standard: 24,problem_id: problem.id)
Division.create(division_id: 3,text: '意識した行動',standard: 24,problem_id: problem.id)
Division.create(division_id: 4,text: '非判断',standard: 24,problem_id: problem.id)
Division.create(division_id: 5,text: '非反応',standard: 21,problem_id: problem.id)
