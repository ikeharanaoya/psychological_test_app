...
Division.create(division_id: 4,text: '感情的な親密さを失うことへの恐怖',standard: 3,max: 6,problem_id: problem.id)
Division.create(division_id: 5,text: '評判を失うことへの恐怖',standard: 2,max: 4,problem_id: problem.id)
